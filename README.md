...
- реализовать вложенность структур
- написать тесты вложенных структур
- другие численные типы?
- написать Функцию Построить список, содержащий все ключи в объектах дерева
